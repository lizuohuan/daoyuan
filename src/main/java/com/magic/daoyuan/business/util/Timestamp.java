...
public class Timestamp {
	 ...
	 * @throws ParseException
	 */
	public static Integer timesTamp2(Date date,String formats) throws ParseException {
		// 获取系统时间
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(
				formats);
		String time = simpleDateFormat.format(date);
		Integer timesTemp = (int) (simpleDateFormat.parse(time).getTime() / 1000);
		return timesTemp;
	}
...
//        calendar.add(Calendar.WEEK_OF_YEAR, -1);
	 ...
	 * @return
	 */
	public static Date parseDate3(Date date,String formats) throws ParseException {
		return parseDate(timesTamp2(date,formats).toString(),formats);
